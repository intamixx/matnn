...
def get_parser():
    ...
    parser.add_argument(
        ...
        default=["python3", "-m", "musicnn.tagger", "/musicnn/audio/TRWJAZW128F42760DD_test.mp", "--model", "MSD_musicnn", "--topN", "3", "--length", "3", "--overlap", "1", "--print", "--save", output_file],
    )
    return parser
...
def generate_job_crd(job_name, image, args):
    ...
    nfsvol = client.V1NFSVolumeSource(path="/exports", server="10.43.3.234")
