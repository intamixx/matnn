...
# Init Kubernetes
POD_CIDR=$1
kubeadm init --pod-network-cidr=${POD_CIDR} --upload-certs > /root/kubeinit.log
...
# Apply Calico
kubectl --kubeconfig=/root/.kube/config apply -f https://raw.githubusercontent.com/projectcalico/calico/v3.30.0/manifests/tigera-operator.yaml
